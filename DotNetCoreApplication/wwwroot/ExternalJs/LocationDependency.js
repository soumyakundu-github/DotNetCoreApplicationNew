...
function SaveLocation() {
    ...
    if (LocName == "") {
        ...
        $.ajax({
            url: "/LocationDependencyInjection/SaveLocation",
            type: "POST",
            dataType: "JSON",
...
function PopulateLocationTable() {
    $.ajax({
        url: "/LocationDependencyInjection/GetAllLocation",
        type: "POST",
        dataType: "JSON",
        contentType: 'application/x-www-form-urlencoded; charset=utf-8',
        data: '{EditId:""}',
...
function EditLocationDetails(LocId) {
    $("#BtnCancel").show();
    $.ajax({
        url: "/LocationDependencyInjection/EditLocation",
        type: "POST",
        dataType: "JSON",
        contentType: 'application/x-www-form-urlencoded; charset=utf-8',
        data: {
...
function DeleteLocationDetails(LocId) {
    $.ajax({
        url: "/LocationDependencyInjection/DeleteLocation",
        type: "POST",
        dataType: "JSON",
        contentType: 'application/x-www-form-urlencoded; charset=utf-8',
        data: {
